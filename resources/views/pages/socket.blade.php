...
@section('content')
    ...
    @auth
        ...
        @if($date_auc <= $now)
            ...
            {{--        </script>--}}
        @else
            <div class="page auction sales" id="example-two">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <ul class="nav whiskey-tabs" class="display: none">
                                            ...
                                            @foreach ($cars as $car)
                                                ...
                                                @if($i==1)
                                                    <li><a href="#tab-{{ $car->id }}"
                                                           class="current">{{ $car->title }}</a></li>
                                                @else
                                                    <li><a href="#tab-{{ $car->id }}">{{ $car->title }}</a>
                                                    </li>
                                                @endif
                                            @endforeach
                                        </ul>
                                                            ...
                                                            <div class="col-md-3">
                                                                <ul class="tabs">
                                                                    <li class="tab-link current"
                                                                        data-tab="tab-1">Характеристики авто
                                                                    </li>
                                                                    <li><a href="{{ route('listings') }}"
                                                                           target="_blank">Список авто</a>
                                                                    </li>
                                                                    <form action="{{ route('auctions.store') }}"
                                                                        ...
                                                                        @if($csum != null)
                                                                            <input id="message" type="text"
                                                                                   name="sum" value="{{ $csum->sum +
                                                                                    $contacts->sum_auc ?? $car->price + $contacts->sum_auc }}">
                                                                            <script>
                                                                                let clicks = {{ $car->price + $contacts->sum_auc }};
                                                                                function onClick() {
                                                                        ...
                                                                        @endif
                                                                        <button class="more" id="send" onClick="onClick()">Отправить
                                                                            заявку
                                                                        </button>
                                                                    </form>
                                                                </ul>
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->status == 1)
                ...
                @if(Request::fullUrl()=="{{ route('socket') }}?tab=tab-1")
                    <script>
                        setInterval((function () {
                            window.location.replace("{{ route('socket') }}?tab=tab-4");
                        }), 500000)
                    </script>
                @endif
                @if(Request::fullUrl() == route('socket'))
                    <script>
                        setInterval((function () {
                            window.location.replace("{{ route('socket') }}?tab=tab-4");
                        }), 500000)
                ...
                @endif
                @if(Request::fullUrl()== route('socket').'?tab=tab-4')
                    <script>
                        setInterval((function () {
                            window.location.replace("{{ route('socket') }}?tab=tab-5");
                        }), 5000)
                    </script>
                @endif
                @if(Request::fullUrl()== route('socket').'?tab=tab-5')
                    <script>
                        setInterval((function () {
                            window.location.replace('{{ route('socket') }}?tab=tab-6');
                        }), 5000)
                    </script>
                @endif
                @if(Request::fullUrl()== route('socket').'?tab=tab-6')
                    <script>
                        setInterval((function () {
                            window.location.replace('{{ route('socket') }}?tab=tab-7');
                        }), 5000)
                    </script>
                @endif
                @if(Request::fullUrl()== route('socket').'?tab=tab-7')
                    <script>
                        setInterval((function () {
                            window.location.replace('{{ route('socket') }}?tab=tab-8');
                        }), 5000)
                    </script>
                @endif
                @if(Request::fullUrl()== route('socket').'?tab=tab-8')
                    <script>
                        setInterval((function () {
                            window.location.replace('{{ route('socket') }}?tab=tab-9');
                        }), 5000)
                    </script>
                @endif
                @if(Request::fullUrl()== route('socket').'?tab=tab-9')
                    <script>
                        setInterval((function () {
...
// NOTE: doesn't take into account existing params
                ...
                {{--      window.location.href = "https://timdjol.com/";--}}
                {{--  }, 15000);--}}
                {{--</script>--}}
