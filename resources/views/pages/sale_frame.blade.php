                                ...
                                <div class="row sales-item">
                                    <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <h3>{{ $car->title }}</h3>
                                                <div class="block year">Год выпуска: {{ $car->year }}</div>
                                                <div class="block engine">Двигатель: {{ $car->engine }}</div>
                                                <div class="block steer">Расположение руля: {{ $car->steer }}</div>
                                                <div class="block transmission">Коробка: {{ $car->transmission }}</div>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="plan">
                                                    ...
                                                    <svg width="736"
                                                        ...
                                                        @isset($car->plk)
                                                            <path
                                                                    style="fill:rgba(255,0,0,.15);" class="path"
                                                                    data-title="PLK"
                                                        ...
                                                        <img src="{{ route('index') }}/img/bg_car1.png" alt=""
                                                             usemap="#map"
                                                             id="image-map"
                                                             class="map">
                                                    </svg>
                                    ...
                                    <div class="col-md-3">
                                        <ul class="tabs">
                                            ...
                                            <li><a href="{{ route('listings') }}" target="_blank">Список авто</a></li>
                                            <form action="{{ route('auctions.store') }}" method="post">
                                                ...
                                                <input type="hidden" name="product_title" value="{{ $car->title }}">
                                                @if($csum != null)
...
@if(Request::fullUrl()=='http://127.0.0.1:8000/sale_frame')
    <script>
        setInterval((function () {
            window.location.replace('http://127.0.0.1:8000/sales?tab=tab-4');
        }), 2000)
    </script>
@endif
@if(Request::fullUrl()=='http://127.0.0.1:8000/sales?tab=tab-4')
    <script>
        setInterval((function () {
            window.location.replace('http://127.0.0.1:8000/sales?tab=tab-5');
        }), 15000)
    </script>
@endif
@if(Request::fullUrl()=='http://127.0.0.1:8000/sales?tab=tab-5')
    <script>
        setInterval((function () {
            window.location.replace('http://127.0.0.1:8000/sales?tab=tab-6');
        }), 20000)
    </script>
@endif
@if(Request::fullUrl()=='http://127.0.0.1:8000/sales?tab=tab-6')
    <script>
        setInterval((function () {
            window.location.replace('http://127.0.0.1:8000/sales?tab=tab-7');
        }), 15000)
    </script>
@endif
@if(Request::fullUrl()=='http://127.0.0.1:8000/sales?tab=tab-7')
    <script>
        setInterval((function () {
            window.location.replace('http://127.0.0.1:8000/sales?tab=tab-8');
        }), 15000)
    </script>
@endif
@if(Request::fullUrl()=='http://127.0.0.1:8000/sales?tab=tab-8')
    <script>
        setInterval((function () {
            window.location.replace('http://127.0.0.1:8000/sales?tab=tab-9');
        }), 15000)
    </script>
@endif
@if(Request::fullUrl()=='http://127.0.0.1:8000/sales?tab=tab-9')
    <script>
        setInterval((function () {
...
{{--        <script src="{{ route('index') }}/js/organictabs.jquery.js"></script>--}}
