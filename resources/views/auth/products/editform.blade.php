            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="home-tab" data-toggle="tab" data-target="#home"
                                    type="button" role="tab" aria-controls="home" aria-selected="true">Характеристики
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="profile-tab" data-toggle="tab" data-target="#profile"
                                    type="button" role="tab" aria-controls="profile"
                                    aria-selected="false">Двигатель
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab3" data-toggle="tab" data-target="#contact"
                                    type="button" role="tab" aria-controls="contact"
                                    aria-selected="false">Трансмиссия
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab4" data-toggle="tab" data-target="#podv"
                                    type="button" role="tab" aria-controls="podv"
                                    aria-selected="false">Подвеска
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab5" data-toggle="tab" data-target="#brake"
                                    type="button" role="tab" aria-controls="brake"
                                    aria-selected="false">Тормозная система
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab6" data-toggle="tab" data-target="#salon"
                                    type="button" role="tab" aria-controls="salon"
                                    aria-selected="false">Салон
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab6" data-toggle="tab" data-target="#kuzov"
                                    type="button" role="tab" aria-controls="kuzov"
                                    aria-selected="false">Кузовные элементы
                            </button>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="year" id="year">
                                                @isset($product)
                                                    <option value="{{ $product->year }}"
                                                            selected>{{ $product->year }}</option>
                                                @else
                                                    <option value="">Выбрать</option>
                                                @endisset
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="oil" id="oil">
                                                @isset($product)
                                                    <option value="{{ $product->oil }}"
                                                            selected>{{ $product->oil }}</option>
                                                @else
                                                    <option value="">Выбрать</option>
                                                @endisset
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="color" id="color">
                                                ...
                                                <option value="Мокрый асфальт"
                                                        @if(old('color') == 'Мокрый асфальт') selected @endif>Мокрый
                                                    асфальт
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="volume" id="volume">
                                                ...
                                                @else
                                                    <option value="">Выбрать</option>
                                                @endisset
                                                <option value="1.3" @if(old('volume') == '1.3') selected @endif>1.3
                                                </option>
                                                <option value="1.4" @if(old('volume') == '1.4') selected @endif>1.4
                                                </option>
                                                <option value="1.5" @if(old('volume') == '1.5') selected @endif>1.5
                                                </option>
                                                <option value="1.6" @if(old('volume') == '1.6') selected @endif>1.6
                                                </option>
                                                <option value="1.7" @if(old('volume') == '1.7') selected @endif>1.7
                                                </option>
                                                <option value="1.8" @if(old('volume') == '1.8') selected @endif>1.8
                                                </option>
                                                <option value="1.9" @if(old('volume') == '1.9') selected @endif>1.9
                                                </option>
                                                <option value="2.0" @if(old('volume') == '2.0') selected @endif>2.0
                                                </option>
                                                <option value="2.1" @if(old('volume') == '2.1') selected @endif>2.1
                                                </option>
                                                <option value="2.2" @if(old('volume') == '2.2') selected @endif>2.2
                                                </option>
                                                <option value="2.3" @if(old('volume') == '2.3') selected @endif>2.3
                                                </option>
                                                <option value="2.4" @if(old('volume') == '2.4') selected @endif>2.4
                                                </option>
                                                <option value="2.5" @if(old('volume') == '2.5') selected @endif>2.5
                                                </option>
                                                <option value="2.6" @if(old('volume') == '2.6') selected @endif>2.6
                                                </option>
                                                <option value="2.7" @if(old('volume') == '2.7') selected @endif>2.7
                                                </option>
                                                <option value="2.8" @if(old('volume') == '2.8') selected @endif>2.8
                                                </option>
                                                <option value="2.9" @if(old('volume') == '2.9') selected @endif>2.9
                                                </option>
                                                <option value="3.0" @if(old('volume') == '3.0') selected @endif>3.0
                                                </option>
                                                <option value="3.1" @if(old('volume') == '3.1') selected @endif>>3.1
                                                </option>
                                                <option value="3.2" @if(old('volume') == '3.2') selected @endif>3.2
                                                </option>
                                                <option value="3.3" @if(old('volume') == '3.3') selected @endif>3.3
                                                </option>
                                                <option value="3.4" @if(old('volume') == '3.4') selected @endif>3.4
                                                </option>
                                                <option value="3.5" @if(old('volume') == '3.5') selected @endif>3.5
                                                </option>
                                                <option value="3.6" @if(old('volume') == '3.6') selected @endif>3.6
                                                </option>
                                                <option value="3.7" @if(old('volume') == '3.7') selected @endif>3.7
                                                </option>
                                                <option value="3.8" @if(old('volume') == '3.8') selected @endif>3.8
                                                </option>
                                                <option value="3.9" @if(old('volume') == '3.9') selected @endif>3.9
                                                </option>
                                                <option value="4.0" @if(old('volume') == '4.0') selected @endif>4.0
                                                </option>
                                                <option value="4.1" @if(old('volume') == '4.1') selected @endif>4.1
                                                </option>
                                                <option value="4.2" @if(old('volume') == '4.2') selected @endif>4.2
                                                </option>
                                                <option value="4.3" @if(old('volume') == '4.3') selected @endif>4.3
                                                </option>
                                                <option value="4.4" @if(old('volume') == '4.4') selected @endif>4.4
                                                </option>
                                                <option value="4.5" @if(old('volume') == '4.5') selected @endif>4.5
                                                </option>
                                                <option value="4.6" @if(old('volume') == '4.6') selected @endif>4.6
                                                </option>
                                                <option value="4.7" @if(old('volume') == '4.7') selected @endif>4.7
                                                </option>
                                                <option value="4.8" @if(old('volume') == '4.8') selected @endif>4.8
                                                </option>
                                                <option value="4.9" @if(old('volume') == '4.9') selected @endif>4.9
                                                </option>
                                                <option value="5.0" @if(old('volume') == '5.0') selected @endif>5.0
                                                </option>
                                                <option value="5.1" @if(old('volume') == '5.1') selected @endif>5.1
                                                </option>
                                                <option value="5.2" @if(old('volume') == '5.2') selected @endif>5.2
                                                </option>
                                                <option value="5.3" @if(old('volume') == '5.3') selected @endif>5.3
                                                </option>
                                                <option value="5.4" @if(old('volume') == '5.4') selected @endif>5.4
                                                </option>
                                                <option value="5.5" @if(old('volume') == '5.5') selected @endif>5.5
                                                </option>
                                                <option value="5.6" @if(old('volume') == '5.6') selected @endif>5.6
                                                </option>
                                                <option value="5.7" @if(old('volume') == '5.7') selected @endif>5.7
                                                </option>
                                                <option value="5.8" @if(old('volume') == '5.8') selected @endif>5.8
                                                </option>
                                                <option value="5.9" @if(old('volume') == '5.9') selected @endif>5.9
                                                </option>
                                                <option value="6.0" @if(old('volume') == '6.0') selected @endif>6.0
                                                </option>
                                                <option value="6.1" @if(old('volume') == '6.1') selected @endif>6.1
                                                </option>
                                                <option value="6.2" @if(old('volume') == '6.2') selected @endif>6.2
                                                </option>
                                                <option value="6.3" @if(old('volume') == '6.3') selected @endif>6.3
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type_own" id="own">
                                                ...
                                                <option value="Юридическое лицо"
                                                        @if(old('type_own') == 'Юридическое лицо')
                                                            selected
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel"
                            ...
                            >
                                @isset($product)
                                    @method('PUT')
                                @endisset
                                <input type="hidden" name="id" value="{{ old('title', isset($product) ?
                                        $product->id : null) }}">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="tengine" id="">
                                                ...
                                                @endisset
                                                <option value="Отличное состояние"
                                                        @if(old('tengine') == 'Отличное состояние')
                                                            selected
                                                        @endif>Отличное состояние
                                                </option>
                                                <option value="Хорошее состояние"
                                                        @if(old('tengine') == 'Хорошее состояние')
                                                            selected
                                                        @endif>Хорошее состояние
                                                </option>
                                                <option value="Требуется вложение"
                                                        @if(old('tengine') == 'Требуется вложение')
                                                            selected
                                                        @endif>Требуется вложение
                                                </option>
                                                <option value="Требуется замена"
                                                        @if(old('tengine') == 'Требуется замена')
                                                            selected
                                    ...
                                    @isset($transmissions)
                                        ...
                                        @foreach($transmissions as $image)
                                            <div class="col-md-2">
                                                <div class="img-item">
                                                    <img src="{{ Storage::url($image->image) }}" alt="">
                                                    <form action="{{ route('transmissions.destroy', $image) }}"
                                                          method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn delete"
                        ...
                        <div class="tab-pane fade" id="podv" role="tabpanel"
                                    ...
                                    @isset($suspensions)
                                        ...
                                        @foreach($suspensions as $image)
                                            <div class="col-md-2">
                                                <div class="img-item">
                                                    <img src="{{ Storage::url($image->image) }}" alt="">
                                                    <form action="{{ route('suspensions.destroy', $image) }}"
                                                          method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn delete"
                        ...
                        <div class="tab-pane fade" id="brake" role="tabpanel"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            состояние')
                                                ...
                                                <option value="Хорошее состояние"
                                                        @if(old('tbrake') == 'Хорошее состояние')
                                                            selected
                                                        @endif>Хорошее состояние
                                                </option>
                                            ...
                                            вложение')
                                                ...
                                                <option value="Требуется замена"
                                                        @if(old('tbrake') == 'Требуется замена')
                                                            selected
                                                        @endif>Требуется замена
                                                </option>
                                            </select>
                                    ...
                                    @isset($brakes)
                                        ...
                                        @foreach($brakes as $image)
                                            <div class="col-md-2">
                                                <div class="img-item">
                                                    <img src="{{ Storage::url($image->image) }}" alt="">
                                                    <form action="{{ route('brakes.destroy', $image) }}"
                                                          method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn delete"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            состояние')
                                                ...
                                                <option value="Хорошее состояние"
                                                        @if(old('tsalon') == 'Хорошее состояние')
                                                            selected
                                                        @endif>Хорошее состояние
                                                </option>
                                            ...
                                            вложение')
                                                ...
                                                <option value="Требуется замена"
                                                        @if(old('tsalon') == 'Требуется замена')
                                                            selected
                                                        @endif>Требуется замена
                                                </option>
                                            </select>
                                    ...
                                    @isset($salons)
                                        ...
                                        @foreach($salons as $image)
                                            <div class="col-md-2">
                                                <div class="img-item">
                                                    <img src="{{ Storage::url($image->image) }}" alt="">
                                                    <form action="{{ route('salons.destroy', $image) }}"
                                                          method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn delete"
                        ...
                        <div class="tab-pane fade" id="kuzov" role="tabpanel"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="tbody" id="">
                                                ...
                                                @endisset
                                                <option value="Отличное состояние"
                                                        @if(old('tbody') == 'Отличное состояние')
                                                            selected
                                                        @endif>Отличное состояние
                                                </option>
                                                <option value="Хорошее состояние"
                                                        @if(old('tbody') == 'Хорошее состояние')
                                                            selected
                                                        @endif>Хорошее состояние
                                                </option>
                                                <option value="Требуется вложение"
                                                        @if(old('tbody') == 'Требуется вложение')
                                                            selected
                                                        @endif>Требуется вложение
                                                </option>
                                    ...
                                    @isset($bodies)
                                        ...
                                        @foreach($bodies as $image)
                                            <div class="col-md-2">
                                                <div class="img-item">
                                                    <img src="{{ Storage::url($image->image) }}" alt="">
                                                    <form action="{{ route('bodies.destroy', $image) }}"
                                                          method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn delete"
